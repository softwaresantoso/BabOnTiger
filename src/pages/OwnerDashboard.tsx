...
export default function AdminDashboard(){
  ...
  return <div><div className="section-head"><div><div className="eyebrow">CONTROL CENTER</div><h1>Dashboard Owner</h1></div><Link className="btn primary" to="/owner/bookings">Kelola Booking</Link></div>
