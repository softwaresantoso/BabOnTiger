...
export default function CustomerAccount() {
  ...
  async function resetPassword() {
    ...
    try {
      ...
      setMessage(
        "Link reset password dikirim ke email akunmu."
      );
    } catch (e) {
      setError(
        e instanceof Error
  ...
  return (
    <div className="account-page">
      ...
      <div className="account-grid">
        ...
        <div className="panel account-security">
          <h3>
            <KeyRound size={18} /> Keamanan akun
          </h3>

          <p className="muted">
            Gunakan email akun untuk menerima link pembuatan
            password baru.
          </p>
